...
ICudaEngine *createEngine(unsigned int maxBatchSize, IBuilder *builder, DataType dt) {
    ...
    IConvolutionLayer *conv3 = network->addConvolution(*pool2->getOutput(0), 384, DimsHW{3, 3},
    ...
    IConvolutionLayer *conv4 = network->addConvolution(*relu3->getOutput(0), 256, DimsHW{3, 3},
    ...
    IConvolutionLayer *conv5 = network->addConvolution(*relu4->getOutput(0), 256, DimsHW{3, 3},
                                                       weightMap["features.10.weight"], weightMap["features.10.bias"]);
    assert(conv5);
    ...
    IFullyConnectedLayer *fc1 = network->addFullyConnected(*pool3->getOutput(0), 4096, weightMap["classifier.1.weight"],
    ...
    IFullyConnectedLayer *fc2 = network->addFullyConnected(*relu6->getOutput(0), 4096, weightMap["classifier.4.weight"],
    ...
    IFullyConnectedLayer *fc3 = network->addFullyConnected(*relu7->getOutput(0), 1000, weightMap["classifier.6.weight"],
